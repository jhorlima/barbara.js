...
this.addMethod("GET");return angular.copy(this)},post:function(a){this.url=angular.isString(a)?a:this.url;this.addMethod("POST");return angular.copy(this)},put:function(a){this.url=angular.isString(a)?a:this.url;this.addMethod("PUT");return angular.copy(this)},"delete":function(a){this.url=angular.isString(a)?a:this.url;this.addMethod("DELETE");return angular.copy(this)},send:function(d,e){var c=this;if(!angular.isFunction(d))throw"Success Callback invalid in $request!";angular.isFunction(e)||(e=
function(){});if(!angular.isDefined(c.url))throw"No url defined in the request methods!";if(angular.isDefined(c.callbackLoad))c.callbackLoad.onLoading();c.config.headers=c.headers;switch(c.method){case "GET":c.config.params=c.parameter;a.get(c.url,c.config).then(function(a){b(a,c,d,e)},function(a){f(a,c,e)});break;case "POST":a.post(c.url,c.parameter,c.config).then(function(a){b(a,c,d,e)},function(a){f(a,c,e)});break;case "PUT":a.put(c.url,c.parameter,c.config).then(function(a){b(a,c,d,e)},function(a){f(a,
c,e)});break;case "DELETE":c.config.data=c.parameter,a["delete"](c.url,c.config).then(function(a){b(a,c,d,e)},function(a){f(a,c,e)})}}}}]);
